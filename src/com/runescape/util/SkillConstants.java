...
public class SkillConstants {
    ...
    public static String[] SKILL_NAMES = {"attack", "defence", "strength", "hitpoints", "ranged", "prayer", "magic",
            ...
            "-unused-"};
    public static boolean[] SKILL_TOGGLES = {true, true, true, true, true, true, true, true, true, true, true, true,
